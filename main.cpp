...
{
	ParametersParser parameters_parser = ParametersParser::from_file("config.param");
	// If "--help" has been called
	if(parameters_parser.parse_param(argc, argv))
		return 0;
	/// @todo Make function to automatically convert and fall back on value
